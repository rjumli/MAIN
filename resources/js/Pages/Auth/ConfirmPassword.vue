                        ...
                        <BCard no-body class="mt-4">
                            ...
                            <BCardBody class="p-4">
                                ...
                                <div class="user-thumb text-center">
                                    <img v-if="$page.props.jetstream.managesProfilePhotos" class="rounded-circle img-thumbnail avatar-md" :src="$page.props.auth.user.profile_photo_url" :alt="$page.props.auth.user.name">
                                    <h5 class="fs-14 mt-3">{{ $page.props.auth.user.name }}</h5>
                                </div>
                                <div class="p-2 mt-4">
