    ...
    <b-modal v-model="showModal" title="Two Factor Authentication" style="--vz-modal-width: 650px;" header-class="p-3 bg-light" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>    
        ...
        <template v-slot:footer>
            ...
            <div v-if="!twoFactorEnabled">
                <Confirm @confirmed="enableTwoFactorAuthentication">
                    <b-button variant="success" :disabled="form.processing" block><i class="ri-save-3-line align-bottom me-1"></i>Enable</b-button>
                </Confirm>
            </div>
            <div v-else>
...
export default {
    ...
    methods : {
        ...
        confirmTwoFactorAuthentication(){
            this.form.post('/user/confirmed-two-factor-authentication', {
